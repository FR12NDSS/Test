			...
			<div class="bginputlogin">
				...
				<div id="loginsection" class="frontsection animate__animated animate__fadeIn" style="display:block;">
				   <div class="insidectloginmb">
				      ...
				      <form action="login_mb.php" method="POST">
				         <div>
				            <div class=" form-group my-2">
				               <div>
				                  ...
				                  <div class="el-input my-1">
				                     ...
				                     <input type="text" placeholder="เบอร์โทรศัพท์" name="phone_mb" class="inputstyle" required>
				                  </div>
				               </div>
				            </div>
				            <div class="form-group my-4">
				               <div>
				                  ...
				                  <div class="el-input my-1">
				                     ...
				                     <input type="password" placeholder="รหัสผ่าน" name="password_mb" class="inputstyle" required>
				                  </div>
				               </div>
				            </div>
				         </div>
				      ...
				      <div class="row m-0">
				         <div class="col-6 p-0 pr-1">
				            <button  class="loginbtn active mt-3" type="submit">
				            <span>
				            เข้าสู่ระบบ
				            </span>
				            </button>
				         ...
				         <div class="col-6 p-0 pl-1">
				            <button type="button" class="loginbtn regisbtn mt-3" onclick="gotoregister()">
				            <span>
				            สมัครสมาชิก
				            </span>
				            </button>
